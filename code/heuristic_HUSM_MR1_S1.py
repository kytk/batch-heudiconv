# heuristic.py for HUSM_MR1_S1
# K. Nemoto 16 Oct 2025
...
def infotodict(seqinfo):
    ...
    #fmap_mag =  create_key('sub-{subject}/fmap/sub-{subject}_magnitude')
    #fmap_field = create_key('sub-{subject}/fmap/sub-{subject}_fieldmap')
    ...
    for idx, s in enumerate(seqinfo):
        ...
        * image_type
        ...
        # DWI
        #if 'DTI_MPG15_b1000' in s.dcm_dir_name:    
